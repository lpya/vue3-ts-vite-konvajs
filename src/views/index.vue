  ...
  linkList: [
    {
      title: '项目实战',
      path: '/advanced',
      coverUrl: '/images/00.png',
    },
    {
      title: '矩形【rect】',
      path: '/1-rect',
      coverUrl: '/images/01.png',
    },
    {
      title: '圆【circle】',
      path: '/2-circle',
      coverUrl: '/images/02.png',
    },
    {
      title: '椭圆【ellipse】',
      path: '/3-ellipse',
      coverUrl: '/images/03.png',
    },
    {
      title: '楔形【wedge】',
      path: '/4-wedge',
      coverUrl: '/images/04.png',
    },
    {
      title: '线【line】',
      path: '/5-line',
      coverUrl: '/images/05.png',
    },
    {
      title: '文本【text】',
      path: '/6-text',
      coverUrl: '/images/06.png',
    },
    {
      title: '星星【star】',
      path: '/7-star',
      coverUrl: '/images/07.png',
    },
    {
      title: '环形【ring】',
      path: '/8-ring',
      coverUrl: '/images/08.png',
    },
    {
      title: '弧形【arc】',
      path: '/9-arc',
      coverUrl: '/images/09.png',
    },
    {
      title: '标签【label】',
      path: '/10-label',
    ...
    },
    {
      title: '组【group】',
      path: '/17-group',
      coverUrl: '/images/17.png',
    },
    {
      title: '变压器、框选【transformer】',
      path: '/18-transformer',
      coverUrl: '/images/18.png',
    },
    {
      title: '画布滚动缩放【wheel】',
      path: '/19-wheel',
      coverUrl: '/images/19.png',
    },
    {
      title: '窗口预览【preview】',
      path: '/20-preview',
      coverUrl: '/images/20.png',
    },
  ]
})
